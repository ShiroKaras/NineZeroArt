...
NSString *const kStorageTableKey              = @"login_user_info_table";

NSString *const kStorageUserInfoKey           = @"kStorageUserInfoKey";
...
NSString *const kStorageUserTokenKey          = @"kStorageUserTokenKey";
